...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.metamorphic_button.clicked.connect(lambda:self.ui.stackedWidget_2.setCurrentWidget(self.ui.metamorphic_page))
    ...
    def create_gallery(self,count):
        ...
        self.gal_label.setPixmap(QPixmap('/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/gallery/{}.jpg'.format(count)))
    ...
    def send_flag_for_rock(self):
        ...
        print('True')
        if self.checker:
            cv2.imwrite("/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/gallery/" + str(self.foto_counter) + ".jpg" ,self.image)
            self.ui.label_33.setPixmap(QPixmap('/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/gallery/'+str(self.foto_counter) + '.jpg'))
