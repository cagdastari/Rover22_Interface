...
class backend(QWidget):
    ...
    def create_frame(self,row,column,name,description):
        ...
        self.image_label.setPixmap(QPixmap('/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/images/{}/{}_1.png'.format(name,name)))
    ...
    def image_slide(self,image):
        ...
        print(sender)
        self.labels[sender].setPixmap(QPixmap('/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/images/{}/{}_1.png'.format(image,image)))


    def image_slide_2(self,image):
        sender=int(self.sender().toolTip())
        print(sender)
        self.labels[sender].setPixmap(QPixmap('/home/cagdas/catkin_ws/src/-22-Rover-Interface-1.0/rover_ui/nodes/images/{}/{}_2.png'.format(image,image)))
